    ...
    with st.container():
        ...
        if clipes_disponiveis:
            ...
            if clipes_filtrados:
                ...
                # Controlos: Play, Pause, Repetir (Loop)
                st.markdown("### Controlo de Reprodução do Clipe")
                ...
                with col_b3:
                    btn_loop = st.checkbox("🔁 Repetir Clipe", value=False)
                
                if btn_play and url_selecionada:
